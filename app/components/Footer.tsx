      ...
      <div className="max-w-6xl mx-auto px-6 py-10">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-6 text-sm text-zinc-400">
            <a href="#" className="hover:text-zinc-100 transition">GitHub</a>
            <a href="#" className="hover:text-zinc-100 transition">LinkedIn</a>
            <a href="mailto:youremail@email.com" className="hover:text-zinc-100 transition">
              Email
            </a>
          </div>
        </div>
