      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-start">
          ...
          <motion.div 
            ...
            className="bg-[#0d0d0d]/80 border border-gray-800 p-6 sm:p-8 rounded-2xl sm:rounded-3xl backdrop-blur-sm shadow-2xl w-full"
          >
            ...
            {roadmap && (
              <div className="mt-6 p-4 bg-gray-900/50 border border-gray-800 rounded-xl text-gray-200 overflow-hidden">
          ...
          <div className="space-y-5 md:space-y-6 w-full">
            ...
            >
              <div className="flex items-center gap-4 sm:gap-5 overflow-hidden">
                <div className="flex-shrink-0 p-3 sm:p-4 bg-blue-600/10 rounded-xl text-blue-500 group-hover:scale-105 transition-transform">
                  <Mail size={22} />
                </div>
                <div className="min-w-0">
                  <h4 className="text-gray-400 text-xs sm:text-sm">Email Me</h4>
                  <p className="text-[13px] sm:text-lg font-medium text-white group-hover:text-blue-400 transition-colors truncate">
                    {emailAddress}
                  </p>
                </div>
              </div>
              <div className="text-gray-500 group-hover:text-blue-400 transition-colors flex-shrink-0 ml-2">
            ...
            {/* WhatsApp Card */}
            <a href={`https://wa.me/${whatsappNumber}`} target="_blank" rel="noopener noreferrer" className="block w-full">
              <motion.div 
                initial={{ opacity: 0, x: 20 }}
                whileInView={{ opacity: 1, x: 0 }}
                whileHover={{ scale: 1.01 }}
                transition={{ duration: 0.6, delay: 0.3 }}
                className="p-4 sm:p-6 bg-[#0d0d0d]/50 border border-gray-800 rounded-2xl flex items-center gap-4 sm:gap-5 hover:border-green-500/50 transition-all group cursor-pointer w-full"
              >
                <div className="flex-shrink-0 p-3 sm:p-4 bg-green-600/10 rounded-xl text-green-500 group-hover:scale-105 transition-transform">
            ...
            <div className="grid grid-cols-3 gap-3 sm:gap-4 pt-2">
              {[
                ...
                >
                  ...
                  <span className="text-[10px] sm:text-xs text-gray-500 uppercase tracking-tighter">
                    {social.label}
                  </span>
                </motion.a>
              ))}
